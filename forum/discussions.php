...
<body style="background:transparent;">
    ...
    $query = "SELECT id, title, description, date_posted FROM questions ORDER BY date_posted DESC";
    $result = mysqli_query($conn, $query);
    ?>

    <div class="container mt-4">
        <h1 class="mb-4">Web Discussions</h1>
            ...
            <?php while ($question = mysqli_fetch_assoc($result)) { ?>
                <div class="question card mb-3">
                    <div class="card-body">
                        ...
                        <a href="question-detail.php?id=<?php echo $question['id']; ?>" class="btn btn-primary">View Details</a>
                    </div>
                </div>
            <?php } ?>
        </div>
        ...
        <div class="post-question" style="border-top:1px solid black;margin-top:2rem;">
            ...
            <form action="post-question.php" method="POST" style="padding:0;">
                <div class="mb-3">
