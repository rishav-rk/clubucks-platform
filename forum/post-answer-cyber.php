...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($question_id && !empty($content)) {
        try {
            ...
            $stmt = $conn->prepare("INSERT INTO answers_cyber (question_id, content, user_id, date_posted) VALUES (?, ?, ?, NOW())");
            ...
            header("Location: question-detail-cyber.php?id=$question_id");
            exit;
