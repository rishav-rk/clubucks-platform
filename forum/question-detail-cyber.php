...
<body style="background:transparent">
    ...
    if ($question_id) {
        ...
        $stmt_question = $conn->prepare("SELECT * FROM questions_cyber WHERE id = ?");
        ...
        if ($question = $result_question->fetch_assoc()) {
            ...
            $stmt_answers = $conn->prepare("SELECT * FROM answers_cyber WHERE question_id = ? ORDER BY date_posted DESC");
            ...
            echo "<form action='post-answer-cyber.php' method='POST' style='padding:0;'>";
